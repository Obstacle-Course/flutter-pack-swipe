...
class SwipeCardPack extends StatefulWidget {
  ...
  @override
  _SwipeCardPackState createState() => _SwipeCardPackState();
...
class _SwipeCardPackState extends State<SwipeCardPack>
  ...
  @override
  void didUpdateWidget(covariant SwipeCardPack oldWidget) {
...
class CardAnimation {
  static Animation<Alignment> frontCardAlign(
    ...
    if (_SwipeCardPackState._trigger == TriggerDirection.none) {
      endX = beginAlign.x > 0
    ...
    } else if (_SwipeCardPackState._trigger == TriggerDirection.left) {
      endX = beginAlign.x - swipeEdge;
      endY = beginAlign.y + 0.5;
    }
    /* Trigger Swipe Up or Down */
    else if (_SwipeCardPackState._trigger == TriggerDirection.up ||
        _SwipeCardPackState._trigger == TriggerDirection.down) {
      var beginY =
          _SwipeCardPackState._trigger == TriggerDirection.up ? -10 : 10;
